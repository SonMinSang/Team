...
class GridFragment : Fragment() {
    ...
    override fun onResume() {
        super.onResume()
//        mainView?.grid_fragment_recyclerview?.adapter = GridFragmentRecyclerViewAdatper()
//        mainView?.grid_fragment_recyclerview?.layoutManager = GridLayoutManager(activity, 3)
    }
