...
class DetailViewFragment :Fragment(){
    ...
    inner class DetailViewRecyclerViewAdapter: RecyclerView.Adapter<RecyclerView.ViewHolder>(){
        ...
        override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
            ...
            // Image
            Glide.with(holder.itemView.context).load(contentDTOs!![position].imageUrl).into(viewholder.card_item_image)
            ...
            // title
            viewholder.card_item_title.text = contentDTOs!![position].title

            // category
            viewholder.card_item_cate.text = contentDTOs!![position].category.toString()

            // location
            viewholder.card_item_location.text = contentDTOs!![position].location
        }
